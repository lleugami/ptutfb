...
class Theme
{
    ...
    private function miniature($mini)
    {
        ...
        $source = imagecreatefromjpeg("/home/guillemain/ptutfb13/group1/web/uploads/images/theme/".$mini); // La photo est la source
        ...
        imagejpeg($destination, '/home/guillemain/ptutfb13/group1/web/uploads/images/mini/theme/mini_'.$mini);
    }
}