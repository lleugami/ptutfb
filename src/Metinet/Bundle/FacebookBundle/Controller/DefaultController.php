        ...
        foreach ($questions as $question){
            ...
            if($nope != 1){
                if( count($question->getAnswers()) >= 1){
                    ...
                    $return .= '<form id="form_question" action="#" method="post" style="position:absolute; top: 100px; left: 33%; background-color: white; padding: 10px; margin:auto; border-radius: 10px; box-shadow: 0 0 2px black; width: 33%; z-index: 10;">';
